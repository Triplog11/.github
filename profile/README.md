...
| 저장소                                                                         | 담당 영역         | 설명                                               |
| --------------------------------------------------------------------------- | ------------- | ------------------------------------------------ |
| [트립로그-app](https://github.com/트립로그11/트립로그-app)                     | Application   | 트립로그 애플리케이션과 백엔드 서버, 기획 문서 및 공통 협업 규칙을 관리합니다. |
| [트립로그-data-modeling](https://github.com/트립로그11/트립로그-data-modeling) | Data Modeling | 서비스의 개념·논리·물리 데이터 모델과 ERD 설계 산출물을 관리합니다.         |
